...
| `nome_municipio` | texto | exibicao | diretorio do IBGE; opcional em exportacoes anteriores |
...
| `pib_per_capita_anterior` | decimal | preditor | PIB municipal de 2023 dividido pela populacao de 2023, em reais por habitante |
